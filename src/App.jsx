...
function CalculateurPlusValue() {
  ...
  const calc = useMemo(function() {
    ...
    if (typeBien === "resid-principale") return { pvBrute, prixRevient, pvNette: 0, impotIR: 0, impotPS: 0, impotTotal: 0, abattIR: 100, abattPS: 100, exonere: true, ans, surtaxe: 0, baseIR: 0, basePS: 0 };
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        <div style={SECTION}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              {[{ val: "resid-principale", label: "🏡 Résidence principale" }, { val: "non-resid", label: "🏢 Bien locatif / secondaire" }].map(function(t) {
            ...
            <div style={SECTION}>
              ...
              {calc.exonere ? (
                <div style={{ background: "rgba(220,252,231,0.8)", borderRadius: 12, padding: "14px", textAlign: "center", border: "1px solid rgba(22,163,74,0.3)" }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 700, color: "#15803d", marginTop: 4 }}>Totalement exonéré !</div>
                  <div style={{ fontSize: 12, color: "#64748b", marginTop: 2 }}>IR et prélèvements sociaux = 0 €</div>
                </div>
              ) : (
                <>
                  <StatRow label={"Base imposable IR (après " + calc.abattIR + "% abatt.)"} value={fmtEur(calc.baseIR)} />
                  ...
                  <StatRow label={"Base PS (après " + Math.round(calc.abattPS) + "% abatt.)"} value={fmtEur(calc.basePS)} />
