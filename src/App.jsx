...
function Dashboard({ projets, onOuvrir, onNav, user }) {
  ...
  if (profil) {
    (profil.revenus || []).forEach(function(r) { totalRevenus += pf(r.montantAnnuel); });
...
function SimulateurExploitation() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {/* Save bar */}
      <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
        <input type="text" value={nomSimu} onChange={function(e) { setNomSimu(e.target.value); }} placeholder="Nom de la simulation..." style={{ flex: 1, minWidth: 160, background: "rgba(248,250,252,0.9)", border: "1px solid rgba(148,163,184,0.4)", borderRadius: 10, padding: "7px 12px", fontSize: 13, outline: "none", color: "#0f172a" }} />
        ...
        {projets.length > 0 && (
          <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
            {projets.slice(0, 5).map(function(p) {
