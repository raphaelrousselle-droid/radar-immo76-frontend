          ...
          {profil.emprunteurs.map(function(emp, idx) {
            ...
            return (<div key={idx} style={{ background: "rgba(248,250,252,0.7)", borderRadius: 12, padding: 12, border: "1px solid rgba(148,163,184,0.15)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
                ...
                {renderField("Ancienneté", prefix + "ancienneteEmployeur", { placeholder: "Depuis le ..." })}
              </div>
            </div>);
          })}
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 10 }}>
          {renderField("Adresse commune", "adresse", { placeholder: "Adresse complète" })}
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
            ...
            {renderField("Depuis le", "ancienneteLogement", { placeholder: "JJ/MM/AAAA" })}
          </div>
        </div>
      </div>
