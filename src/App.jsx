...
function SimulationProjet() {
  ...
  const PHOTOS_KEY = "radar-immo-photos-v1";

  // Photos persistées dans localStorage, indépendantes du cycle de vie du composant
  const [photos, setPhotos] = useState(function() {
    try { return JSON.parse(localStorage.getItem("radar-immo-photos-v1")) || []; }
    catch(e) { return []; }
  });

  // Sync localStorage à chaque modification des photos
  useEffect(function() {
