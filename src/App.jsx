          ...
          <div style={Object.assign({}, SECTION, { padding: "14px 20px" })}>
            ...
            <div style={{ position: "relative" }}>
              ...
              {communeSuggestions.length > 0 && (
                <div style={{ position: "fixed", zIndex: 9999, background: "#fff", border: "1px solid rgba(148,163,184,0.3)", borderRadius: 10, boxShadow: "0 8px 24px rgba(0,0,0,0.18)", marginTop: 4, overflow: "hidden", minWidth: 280, maxWidth: 480 }}
                  ref={function(el) {
                    if (!el) return;
                    var input = el.previousSibling;
                    if (!input) return;
                    var parent = el.parentElement && el.parentElement.querySelector("input");
                    if (parent) {
